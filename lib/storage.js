const DEFAULT_SETTINGS = {
	...
	promptTemplate: `Group these tabs by topic/domain/category. Create 2-7 groups max. Create group which a user may seem helpful when there are a lot of tabs.
