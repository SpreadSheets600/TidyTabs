...
export const DEFAULT_PROMPT_TEMPLATE = `Analyze the provided tab data (titles, URLs, domains) to intelligently group tabs by their primary topic, purpose, or category. Consider user intent and browsing patterns. Also consider grouping based on domains if needed.

Create 2-10 groups max. Use descriptive but concise labels (2-4 words). If tabs don't fit well, create a "Miscellaneous" group.
