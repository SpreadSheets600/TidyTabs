const DEFAULT_SETTINGS = {
	...
	promptTemplate: `Analyze the provided tab data (titles, URLs, domains) to intelligently group tabs by their primary topic, purpose, or category. Consider user intent and browsing patterns. Also consider grouping based on domains if needed.
